 ...
 * 현재 개발된 애플리케이션의 문제점
 * 	1.
 * 		하나의 메소드에관게가 없는 많은 기능이 구현되어 있음 (낮은 응집도)
 * 		향후 각 기능에 대해 신규 요구사항 및 긴의 확장 시 현재의 메소드의 코드가 게속 증가되게  됨
 * 
 * 		따라서, 향후 기능 파악과 구분이 힘들어지게 됨 => 유지보수가 어려워지게됨
 * 
 * 	2.
 ...
 * 		- 클래스각 변경 및 수정되어야 하는 이유는 오직 하냐여야 함
...
public class MainApplication {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 유연한 코드 작성
        // BankStatementParser 는 인터페이스니까 구현체를 확인할 필요
        
        // ********* csv 파일을 파싱하는 책임을 지고 있음 *********
        final BankStatementParser bankStatementParser
                = new BankStatementCSVParser();

        // CSV 파싱에 필요한 parser 를 지정
